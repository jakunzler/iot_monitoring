#!/usr/bin/env python3
"""
Script Simplificado para Testar Fluxo Completo: DHT22 (Pino 11) → Raspberry Pi → RM520N-GL → Backend
Versão simplificada usando adafruit_dht
"""
...
def main():
    ...
    for i in range(total_attempts):
        ...
        # Ler sensor
        temperature, humidity, temperature_f = read_dht22()
