...
const ESP32Dashboard = () => {
  ...
  const chartOptions = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: 'Histórico de Temperatura e Umidade - ESP32',
        font: {
          size: 16,
        },
      },
  ...
  if (loading) {
    return (
      <Container maxWidth={false} disableGutters sx={{ px: 2, py: 1, flex: 1, display: 'flex', flexDirection: 'column', height: '100%' }}>
    ...
    <Box sx={{ 
      ...
      <Container maxWidth="xl" sx={{ 
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 1.5 }}>
          <Wifi sx={{ fontSize: 28, color: 'primary.main' }} />
          <Box>
            <Typography variant="h5" component="h1" sx={{ fontWeight: 'bold', lineHeight: 1.2 }}>
              ESP32 Dashboard
            </Typography>
            <Typography variant="body2" color="text.secondary" sx={{ fontSize: '0.875rem' }}>
              Monitoramento Wi-Fi com DHT22
            </Typography>
          </Box>
          <Chip label="Wi-Fi" color="primary" size="small" sx={{ ml: 'auto' }} />
        </Box>
