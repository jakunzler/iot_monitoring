...
### Scripts de teste (legacy, `code/publisher/deprecated/`)
- `test_dht22_pin11_rm520n.py` – DHT22 + Pino 11 + RM520N-GL
- `setup_rm520n_dht22.py` – RM520N-GL + DHT22
- `test_pin11_rm520n.py`, `test_pin11_dht11.py`, `validate_complete_flow.py`, `configure_rm520n.py`, `run_tests.sh`

### Servidor e dashboard activos
- `code/backend/server.py` – API
- `code/frontend/src/pages/PiCarXDashboard.jsx` – Dashboard PiCarX / 5G

### Publisher em producao (`code/publisher/`, nao deprecated)
- `publish_picarx_dht22.py`, `systemd/`, `install-systemd.sh`

## 🚀 Como Usar

### 1. Execução rápida (menu legacy)
```bash
cd code/publisher/deprecated
chmod +x run_tests.sh
./run_tests.sh
```

### 2. Teste DHT22 + Pino 11 + RM520N-GL
```bash
cd code/publisher/deprecated
